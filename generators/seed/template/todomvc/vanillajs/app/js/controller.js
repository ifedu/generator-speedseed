((window) => {
    ...
    class Controller {
        constructor(model, view) {
            ...
            this.view.bind('toggleAll', () => this.toggleAll(status.completed))
        }
        ...
        editItem(id) {
            this.model.read(id, (data) => this.view.render('editItem', {id: id, title: data[0].title}))
        }
        ...
        editItemSave(id, title) {
            ...
            (title.length !== 0)
                ? this.model.update(id, {title: title}, () => this.view.render('editItemDone', {id: id, title: title}))
                : this.removeItem(id)
        }

        editItemCancel(id) {
            this.model.read(id, (data) => this.view.render('editItemDone', {id: id, title: data[0].title}))
        }
